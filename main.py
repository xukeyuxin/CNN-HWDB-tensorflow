...
parser.add_argument("-b", "--class_num", type=int, default=3755)
parser.add_argument("-l", "--init_lr", type=float, default=1e-2)

parser.add_argument("-ac", "--action", type=str, default='attack')
parser.add_argument("-ac", "--summary_dir", type=str, default='logs')
parser.add_argument("-ac", "--model_save_path", type=str, default='model')
